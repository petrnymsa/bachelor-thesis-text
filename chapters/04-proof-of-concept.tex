...
A note about the Transaction Box Control. It derives from \mintinline{C}{SKCanvasView}, which comes from SkiaSharp. The class provides method \mintinline{C}{void OnPaintSurface(SKPaintSurfaceEventArgs e)} which is called every time when the graphics must be refreshed. \mintinline{C}{SKPaintSurfaceEventArgs} object provides \mintinline{C}{SKCanvas} which contains methods for basic 2D drawing. 
% ---------------------------------------------------------------------------------
